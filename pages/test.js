            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  Identifiers, including relating to data used to identify you,
                  such as full name, email, address, birthdate (month and day),
                  and phone number. Contact details, such as real name, alias,
                  postal address, telephone or mobile contact number, unique
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  applications, systems and advertisements. device information,
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  connection with our business activities, photo or avatar,
                  videos, and recordings of phone calls between you and us,
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  Including communication preferences, customer service and
                  communications history, personal information you permit us to
                  see when interacting with us through social media, and
                  personal information you provide us in relation to a question,
                  request, inquiry, survey, contest or promotion.
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <i className="fas fa-times-circle"></i>
                </td>
              ...
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  including our predictions about your interests and preferences
                  and related Service Profile Information.
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <i className="fas fa-times-circle"></i>
                </td>
