                    ...
                    <ul className="list-none">
                      <li className="py-1">
                        <div className="flex items-center">
                          <div>
                            <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-stone-900 bg-white mr-3">
                              <i className="fas fa-hamburger"></i>
                            </span>
                          </div>
                          <div>
                            <h4 className="text-stone-500 text-left">
                              Food Delivery
                            </h4>
                          </div>
                        </div>
                      ...
                      <li className="py-1">
                        <div className="flex items-center">
                          <div>
                            <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-stone-500 bg-white mr-3">
                ...
                <div className="md:pr-12">
                  ...
                  <ul className="list-none mt-6">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-stone-500 bg-stone-100 mr-3">
