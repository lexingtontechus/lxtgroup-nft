  ...
  return (
    <>
      ...
      <main className="profile-page">
        ...
        <section className="relative py-16 bg-stone-200">
          <div className="container mx-auto px-4">
            <div className="relative flex flex-col min-w-0 break-words bg-stone-100 w-full mb-6 shadow-xl rounded-lg -mt-64">
              <div className="px-6">
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                    <div className="py-6 px-3 mt-16 sm:mt-0">
                      <button
                        className="bg-stone-700 active:bg-stone-400 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                        type="button"
                      >
                ...
                <div className="text-center mt-12">
                  <h3 className="text-4xl font-semibold leading-normal mb-2 text-stone-700 mb-2">
                    LXT GROUP LLC
                  </h3>
                  <div className="text-sm leading-normal mt-0 mb-2 text-stone-400 font-bold uppercase">
                    <i className="fas fa-map-marker-alt mr-2 text-lg text-stone-600"></i>{" "}
                    Los Angeles, California
                  </div>
                  <div className="mb-2 text-stone-600 mt-10">
                  ...
                  <button
                    className="align-middle bg-stone-100 text-white w-4 h-4 rounded-full outline-none focus:outline-none mr-1 mb-1"
                    type="button"
                  >
                    <img
                      src="/polygon.svg"
                  ...
                  <a
                    className="mb-2 text-stone-600 text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                ...
                <div className="mt-10 py-10 border-t border-stone-200 text-center">
                  <div className="flex flex-wrap justify-center">
