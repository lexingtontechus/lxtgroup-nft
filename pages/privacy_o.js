                    ...
                    <table className="table-auto items-center w-full bg-transparent border-collapse">
                      <thead>
                        <tr>
                          ...
                          <th
                            className={
                              "sm:hidden md:hidden xs:hidden px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left " +
                              (color === "light"
                                ? "bg-blueGray-50 text-blueGray-500 border-blueGray-100"
                                : "bg-blueGray-600 text-blueGray-200 border-blueGray-500")
                            }
                          ...
                          <th
                            className={
                              "sm:hidden md:hidden xs:hidden overflow-ellipsis px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left " +
                              (color === "light"
                                ? "bg-blueGray-50 text-blueGray-500 border-blueGray-100"
                                : "bg-blueGray-600 text-blueGray-200 border-blueGray-500")
                            }
                      ...
                      <tbody>
                        <tr>
                          <td className="text-justify">Identifiers</td>
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            Identifiers, including relating to data used to
                            identify you, such as full name, email, address,
                            birthdate (month and day), and phone number. Contact
                          ...
                          <td className="text-center sm:hidden md:hidden xs:hidden">
                        ...
                        <tr>
                          ...
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            Transaction information, purchase history, account
                            history and products or services purchased,
                            obtained, or considered, financial details and
                            payment information
                          </td>
                          <td className="text-center">
                            <i className="fas fa-times-circle"></i>
                        ...
                        <tr>
                          ...
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            ...
                            device information, logs, IP address, and analytics
                            data
                          </td>
                          <td className="text-center">
                            <i className="fas fa-times-circle"></i>
                        ...
                        <tr>
                          <td className="text-justify">Geolocation data</td>
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            Device location
                          </td>
                          <td className="text-center">
                        ...
                        <tr>
                          ...
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            ...
                            in connection with our business activities, photo or
                            avatar, videos, and recordings of phone calls
                            between you and us, where permitted by law.
                          </td>
                          <td className="text-center">
                            <i className="fas fa-times-circle"></i>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            ...
                            apply for a job with us. Including communication
                            preferences, customer service and communications
                            history, personal information you permit us to see
                            when interacting with us through social media, and
                            personal information you provide us in relation to a
                            question, request, inquiry, survey, contest or
                            promotion.
                          </td>
                          <td className="text-center">
                            <i className="fas fa-times-circle"></i>
                        ...
                        <tr>
                          ...
                          <td className="sm:hidden md:hidden xs:hidden text-center">
                            ...
                            preferences and characteristics, including our
                            predictions about your interests and preferences and
