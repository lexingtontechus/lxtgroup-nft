          ...
          <div className="container relative mx-auto">
            <div className="items-center flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-primary-50 font-bold text-4xl uppercase">
                    Terms of Service
                  </h1>
                </div>
              </div>
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      ...
                      <ul className="list-disc mr-auto">
                        <li className="flex items-center">
                          <span className="inline-block ml-2 text-primary-100">
                           - Crypto-Currency
                          </span>
                        </li>
                        <li className="flex items-center">
                      ...
                      <ul className="list-none mr-auto text-primary-100">
                        <li className="flex items-center">
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100 mt-2">
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100">SOCIAL MEDIA </h3>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        {" "}
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100">SUBMISSIONS </h3>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        {" "}
                      ...
                      <h4 className="text-xl font-semibold text-primary-100">Restrictions</h4>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100">CORRECTIONS </h3>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100">DISCLAIMER </h3>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        {" "}
                      ...
                      <h3 className="text-2xl font-semibold text-primary-100">CONTACT US </h3>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        {" "}
