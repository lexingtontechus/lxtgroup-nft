            ...
            <div className="w-full lg:w-10/12 px-4">
              <div className="relative flex flex-col min-w-0 break-words w-full mt-8 mb-6 shadow-lg rounded-lg bg-base-100">
                <div className="flex-auto p-5 lg:p-10">
                  ...
                  <p className="mt-4 text-lg font-boldtext-primary-content">
                  ...
                  <div className="relative w-full mb-3 mt-8">
                    <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                      ...
                      GROUP (“LXT GROUP“, “we”, “us”, or “our”), concerning your
                      access to and use of the http://www.lxtgroup.nft website
                      as well as any other media form, media channel, mobile
                      website or mobile application related, linked, or
                      otherwise connected thereto (collectively, the “Site”).
                      The Site provides an online marketplace for the following
                      goods, products, and/or services: Consulting, management &
                      business services (the “Marketplace Offerings”). In order
                      to help make the Site a secure environment for the
                      purchase and sale of Marketplace Offerings, all users are
                      required to accept and comply with these Terms of Use. You
                  ...
                  >
                    ...
                    <div className="collapse-content">
                      <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                        ...
                        our Privacy Policy:{" "}
                        <span>
                          <Link href="https://lxtgroup.nft/privacy">
                            https://lxtgroup.nft/privacy
                          </Link>
                        </span>
                        . By using the Site or the Marketplace Offerings, you
