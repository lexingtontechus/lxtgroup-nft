  ...
  return (
    <>
      <main>
        ...
        <section className="relative bg-primary-200 py-16">
          <div className="container mx-auto px-4">
            <div className="relative -mt-64 mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-primary-600 px-6 shadow-xl">
              ...
              <div className="mt-12 pt-8 text-center">
                <h3 className="mb-2 mt-4 text-4xl font-semibold leading-normal text-primary-50">
                  LXT GROUP LLC
                </h3>
                <div className="mb-2 mt-0 text-sm font-bold uppercase leading-normal text-primary-100">
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        height="25"
                        width="25"
                        className="fill-primary-100 hover:fill-secondary-400"
                      >
                ...
                <div className="mb-2 mt-10 text-primary-100">
                ...
                <Link
                  className="mb-2 mr-4 inline-block whitespace-nowrap py-2 text-sm font-bold uppercase leading-relaxed text-primary-100"
              ...
              <div className="mt-10 border-t border-primary-200 py-10 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full px-4 lg:w-9/12">
                    <h3 className="mb-2 text-4xl font-semibold leading-normal text-primary-100">
