              ...
              <div className="w-full lg:w-10/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mt-8 mb-6 shadow-lg rounded-lg bg-base-100">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <p className="mt-4 text-lg font-bold text-primary-content">
                    ...
                    >
                      ...
                      <div className="collapse-content">
                        ...
                        <ul className="list-none mr-auto">
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              Administer prize draws and competitions. We may
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              ...
                              the user. We may use your information to provide
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              ...
                              users. We may use your information to respond to
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              ...
                              communications. We and/or our third-party
                              marketing partners may use the personal
                              ...
                              You can opt-out of our marketing emails at any
                              time
                              <br />
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              Deliver targeted advertising to you. We may use
                              your information to develop and display
                              personalized content and advertising (and work
                    ...
                    >
                      ...
                      <div className="collapse-content">
                        ...
                        <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                          ...
                          age 18, please contact us at legal@lxtgroup.nft.
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className="collapse-content">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-normal p-4">
                                  Identifiers, including relating to data used
                                  to identify you, such as full name, email,
                                  address, birthdate (month and day), and phone
                                  number. Contact details, such as real name,
                                  alias, postal address, telephone or mobile
                              ...
                              <tr>
                                ...
                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-normal p-4">
                                  ...
                                  and advertisements. device information, logs,
                            ...
                            similar information*/}
                              ...
                              <tr>
                                ...
                                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-normal p-4">
                                  ...
                                  personal information you provide us in
                                  relation to a question, request, inquiry,
                        ...
                        <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                          ...
                          Lexington Tech will not sell personal information in
                        ...
                        <ul className="list-none mr-auto">
                          ...
                          <li className="flex items-center">
                            <span className="inline-block ml-2 text-primary-content">
                              ...
                              upon the request as soon as feasibly possible, but
                              no later than 15 days from the date of the request
                              submission.
                            </span>
                          </li>
                        </ul>
                        <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                          ...
                          at legal@lxtgroup.nft, by visiting
                    ...
                    >
                      ...
                      <div className="collapse-content">
                        <p className="leading-relaxed mt-1 mb-4 text-primary-content">
                          ...
                          you may email us at legal@lxtgroup.nft or by post to:
                        </p>
                        <ul className="list-none mr-auto">
                          <li className="flex items-center">
                            <img
