                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mt-8 mb-6 shadow-lg rounded-lg bg-primary-400">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      ...
                      <h5 className="text-2xl font-semibold text-primary-100">
                    ...
                    <Link href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm"></Link>
                      </p>      
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        If you are a resident in Switzerland, the contact
                        details for the data protection authorities are
                        available here:
                        <Link href="https://www.edoeb.admin.ch/edoeb/en/home.html"></Link>
                      </p>
                      <p className="leading-relaxed mt-1 mb-4 text-primary-100">
                        ...
                        <table className="items-center w-full bg-transparent border-collapse">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <FontAwesomeIcon icon={faCircleCheck} size="sm" className="text-emerald-500"/>
                              </td>
                              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                <div className="flex">
                                <FontAwesomeIcon icon={faCircleXmark} size="sm" className="text-red-500"/>
                                </div>
                              </td>
                              <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
